...
//       // Używamy przekazanego userId, by dodać zdjęcie do odpowiedniej galerii
//       const id = userId;
...
//       // Dodajemy zdjęcie do Firestore w galerii użytkownika
//       await addDoc(collection(db, `galleries/${id}/photos`), {
//         url,
//         timestamp: serverTimestamp(),
//       });

//       onClose(); // Zamykamy modal po udanym dodaniu zdjęcia
//     } catch (error) {
